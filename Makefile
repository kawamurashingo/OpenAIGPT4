...
#     NAME => q[OpenAIGPT4]
#     PREREQ_PM => { HTTP::Request::Common=>q[0], JSON=>q[0], LWP::Protocol::https=>q[0], LWP::UserAgent=>q[0] }
#     TEST_REQUIRES => {  }
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="OpenAIGPT4" VERSION="0.10">' > OpenAIGPT4.ppd
